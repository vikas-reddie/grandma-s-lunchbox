...
import './globals.css'
export const metadata: Metadata = { title: "Grandma's Lunchbox | Home-cooked lunch at work", description: "Fresh home-style lunch delivered to ITPL offices every weekday.", generator: 'Next.js' }
